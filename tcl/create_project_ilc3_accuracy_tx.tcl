# ============================================================
# create_project_ilc3_accuracy_tx.tcl
# ILC3 accuracy TX with sample strobe and frame sync
# ============================================================

set PART       "xc7z020clg400-1"
set PROJ_NAME  "ilc3_accuracy_tx"
set PROJ_DIR   "[file normalize {C:/zybo_z7_20_prebringup/build/vivado_ilc3_accuracy_tx}]"
...
set STROBE_OFFSET_CLKS [expr {[info exists ::env(STROBE_OFFSET_CLKS)] ? $::env(STROBE_OFFSET_CLKS) : 62}]
set STROBE_PULSE_CLKS [expr {[info exists ::env(STROBE_PULSE_CLKS)] ? $::env(STROBE_PULSE_CLKS) : 16}]

create_project $PROJ_NAME $PROJ_DIR -part $PART -force

add_files -norecurse [list \
    $RTL_DIR/top_ilc3_accuracy_tx_board.v \
    $RTL_DIR/uart_tx_simple.v \
]

set_property top top_ilc3_accuracy_tx_board [current_fileset]
...
puts "ILC3 accuracy TX SYMBOL_HOLD_CLKS=$SYMBOL_HOLD_CLKS STROBE_OFFSET_CLKS=$STROBE_OFFSET_CLKS STROBE_PULSE_CLKS=$STROBE_PULSE_CLKS"
