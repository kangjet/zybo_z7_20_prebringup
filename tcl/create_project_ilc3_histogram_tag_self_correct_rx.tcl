# ============================================================
# create_project_ilc3_histogram_tag_self_correct_rx.tcl
# ILC3 256B packet PHY RX with invalid-state TAG validation
# plus RX-only level histogram logging and self-correction hooks.
# ============================================================

set PART       "xc7z020clg400-1"
set PROJ_NAME  "ilc3_histogram_tag_self_correct_rx"
set PROJ_DIR   "[file normalize {C:/zybo_z7_20_prebringup/build/vivado_ilc3_histogram_tag_self_correct_rx}]"
...
add_files -norecurse [list \
    $RTL_DIR/top_ilc3_histogram_tag_self_correct_rx_board.v \
    $RTL_DIR/ilc3_core/ilc3_rx_core.v \
    $RTL_DIR/uart_tx_simple.v \
]

set_property top top_ilc3_histogram_tag_self_correct_rx_board [current_fileset]
...
puts "ILC3 Histogram TAG self-correct RX SYMBOL_HOLD_CLKS=$SYMBOL_HOLD_CLKS TAG_INTERVAL_SYMBOLS=$TAG_INTERVAL_SYMBOLS TAG_PAIR_COUNT=$TAG_PAIR_COUNT"
