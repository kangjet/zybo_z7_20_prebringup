# ============================================================
# create_project_ilc3_packet256_tx.tcl
# ILC3 256B packet PHY TX over analog accuracy path
# ============================================================

set PART       "xc7z020clg400-1"
set PROJ_NAME  "ilc3_packet256_tx"
set PROJ_DIR   "[file normalize {C:/zybo_z7_20_prebringup/build/vivado_ilc3_packet256_tx}]"
...
puts "ILC3 packet256 TX SYMBOL_HOLD_CLKS=$SYMBOL_HOLD_CLKS STROBE_OFFSET_CLKS=$STROBE_OFFSET_CLKS STROBE_PULSE_CLKS=$STROBE_PULSE_CLKS"
