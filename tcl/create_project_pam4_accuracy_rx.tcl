# ============================================================
# create_project_pam4_accuracy_rx.tcl
# PAM4 accuracy RX with strobe/sync expected-sequence compare
# ============================================================

set PART       "xc7z020clg400-1"
set PROJ_NAME  "pam4_accuracy_rx"
set PROJ_DIR   "[file normalize {C:/zybo_z7_20_prebringup/build/vivado_pam4_accuracy_rx}]"
...
add_files -norecurse [list \
    $RTL_DIR/top_pam4_accuracy_rx_board.v \
    $RTL_DIR/uart_tx_simple.v \
]

set_property top top_pam4_accuracy_rx_board [current_fileset]
...
puts "PAM4 accuracy RX SYMBOL_HOLD_CLKS=$SYMBOL_HOLD_CLKS"
