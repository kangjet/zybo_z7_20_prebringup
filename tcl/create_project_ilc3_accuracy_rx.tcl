# ============================================================
# create_project_ilc3_accuracy_rx.tcl
# ILC3 accuracy RX with strobe/sync expected-sequence compare
# ============================================================

set PART       "xc7z020clg400-1"
set PROJ_NAME  "ilc3_accuracy_rx"
set PROJ_DIR   "[file normalize {C:/zybo_z7_20_prebringup/build/vivado_ilc3_accuracy_rx}]"
...
set_property top top_ilc3_accuracy_rx_board [current_fileset]
...
puts "ILC3 accuracy RX SYMBOL_HOLD_CLKS=$SYMBOL_HOLD_CLKS"
