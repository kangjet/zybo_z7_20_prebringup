...
//   header   : 01 03 01 00 SEQ3 SEQ2 SEQ1 SEQ0
...
//
// Log:
//   ILC3PTX PK=XXXXXXXX SA=XXXXXXXX DP=XXXXXXXX
//=============================================================
module top_ilc3_packet256_tx_board #(
...
function [7:0] log_char;
    ...
    begin
        case (ptr)
            6'd0:  log_char = "I"; 6'd1:  log_char = "L"; 6'd2:  log_char = "C"; 6'd3:  log_char = "3";
